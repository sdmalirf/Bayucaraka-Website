...
export default function Footer() {
  return (
    <div className="flex flex-col py-8 px-16 gap-8 text-white bg-slate-950">
      <div className="flex justify-between max-lg:flex-col">
        <div className="flex-col flex gap-6">
          <h3 className="text-5xl font-bold">BAYUCARAKA</h3>
        ...
        <div className="flex flex-col gap-3">
          ...
          <div className="flex justify-center space-x-5 max-lg:justify-start">
            <a
              href="#"
      ...
      <hr className="border-1 border-white w-full font-normal text-sm" />
      <p>
